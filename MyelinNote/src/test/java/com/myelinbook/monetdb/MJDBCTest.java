package com.myelinbook.monetdb;
import java.sql.*;
...
public class MJDBCTest {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:monetdb://192.168.0.43:50000/voc?so_timeout=10000", "monetdb", "monetdb");
            // make a statement object
            st = con.createStatement();
            // make a executeand SQL query which returns a ResultSet object
            rs = st.executeQuery("SELECT type, COUNT(*) AS total FROM onboard_people GROUP BY type ORDER BY type;");
